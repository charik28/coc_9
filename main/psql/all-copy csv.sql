...
COPY alpassint.tb_coc_amo ("amo_ref_no", "amo_qty", "amo_calb", "orgn_cd", "del_yn", "use_yn", "frst_regst_id",
                           ...
                           "white_yn") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_amo_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
FROM alpassint.tb_coc_amo_oprn_rel;
COPY alpassint.tb_coc_amo_oprn_rel ("oprn_ref_no", "amo_qty", "amo_ref_no") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_amo_oprn_rel_202509020829.csv' DELIMITER ',' CSV HEADER;
/*select count(*)
...
COPY alpassint.tb_coc_arm ("arm_ref_no", "arm_srno", "arm_mx_cp_ch", "arm_cd", "orgn_cd", "del_yn", "use_yn",
                           ...
                           "arm_stts") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_arm_202509020829.csv' DELIMITER ',' CSV HEADER;
*/select count(*)
FROM alpassint.tb_coc_arm_oprn_rel;
COPY alpassint.tb_coc_arm_oprn_rel ("oprn_ref_no", "arm_ref_no") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_arm_oprn_rel_202509020829.csv' DELIMITER ',' CSV HEADER;
...
COPY alpassint.tb_coc_brq ("brq_ref_no", "sctr_cd", "orgn_cd", "brq_dt", "dptm_cd", "dptm_nm", "inf_type", "brq_dt_tm",
                           ...
                           "curr_cd") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_brq_202509020829.csv' DELIMITER ',' CSV HEADER;
...
COPY alpassint.tb_coc_brq_cag ("brq_cag_ref_no", "brq_ref_no", "cag_tp", "cag_qty", "cag_wg", "cag_frd_val_unit",
                               ...
                               "curr_cd") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_brq_cag_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_coc_brq_cag_h ("hist_id", "brq_cag_ref_no", "brq_ref_no", "cag_tp", "cag_qty", "cag_wg",
                                 ...
                                 "curr_cd") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_brq_cag_h_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_coc_brq_emp ("brq_emp_ref_no", "brq_ref_no", "emp_pbsr_no", "emp_fmnm", "emp_nm", "emp_fonc_nm",
                               "emp_grd_nm") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_brq_emp_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
FROM alpassint.tb_coc_brq_emp;
COPY alpassint.tb_coc_brq_emp ("brq_emp_ref_no", "brq_ref_no", "emp_pbsr_no", "emp_fmnm", "emp_nm", "emp_fonc_nm",
                               "emp_grd_nm") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_brq_emp_202509020835.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_coc_brq_emp_h ("hist_id", "brq_emp_ref_no", "brq_ref_no", "emp_pbsr_no", "emp_fmnm", "emp_nm",
                                 ...
                                 "update_at") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_brq_emp_h_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
FROM alpassint.tb_coc_brq_emp_h;
COPY alpassint.tb_coc_brq_emp_h ("hist_id", "brq_emp_ref_no", "brq_ref_no", "emp_pbsr_no", "emp_fmnm", "emp_nm",
                                 "emp_fonc_nm", "emp_grd_nm",
                                 "update_at") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_brq_emp_h_202509020835.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_coc_brq_h ("hist_id", "brq_ref_no", "sctr_cd", "orgn_cd", "brq_dt", "dptm_cd", "dptm_nm", "inf_type",
                             ...
                             "cmpny_addr") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_brq_h_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_coc_brq_inc_acc ("inc_acc_ref_no", "sctr_cd", "orgn_cd", "inc_acc_dt", "dptm_cd", "dptm_nm",
                                   ...
                                   "brq_long") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_brq_inc_acc_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_coc_brq_inc_acc_h ("hist_id", "inc_acc_ref_no", "sctr_cd", "orgn_cd", "inc_acc_dt", "dptm_cd",
                                     ...
                                     "brq_long") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_brq_inc_acc_h_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_coc_brq_prsn ("brq_prsn_ref_no", "brq_ref_no", "brq_prsn_tp_cd", "prsn_nm", "prsn_fm_nm",
                                ...
                                "dlv_agncy") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_brq_prsn_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_coc_brq_prsn_h ("hist_id", "brq_prsn_ref_no", "brq_ref_no", "brq_prsn_tp_cd", "prsn_nm", "prsn_fm_nm",
                                  ...
                                  "dlv_agncy") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_brq_prsn_h_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_coc_brq_trnp ("brq_trnp_ref_no", "brq_ref_no", "trnp_tp", "trnp_mt", "trnp_chss_no", "trnp_prtr",
                                "trnp_val",
                                "curr_cd") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_brq_trnp_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_coc_brq_trnp_h ("hist_id", "brq_trnp_ref_no", "brq_ref_no", "trnp_tp", "trnp_mt", "trnp_chss_no",
                                  ...
                                  "curr_cd") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_brq_trnp_h_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_coc_brq_vldt ("brq_vldt_ref_no", "brq_ref_no", "id_user", "pbsr_no", "emp_nm", "emp_fmnm", "sctr_cd",
                                ...
                                "last_chg_dttm") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_brq_vldt_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_coc_cnn ("cnn_ref_no", "cnn_nm", "cnn_age", "cnn_tp", "cnn_bld", "cnn_spcl", "cnn_rc", "cnn_img",
                           ...
                           "last_chg_dttm") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_cnn_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
FROM alpassint.tb_coc_emp_oprn_rel;
COPY alpassint.tb_coc_emp_oprn_rel ("oprn_ref_no", "co_emp_ref_no") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_emp_oprn_rel_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
FROM alpassint.tb_coc_emp_oprn_rel;--2277
truncate table alpassint.tb_coc_emp_oprn_rel;
COPY alpassint.tb_coc_emp_oprn_rel ("oprn_ref_no", "co_emp_ref_no") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_emp_oprn_rel_202509020835.csv' DELIMITER ',' CSV HEADER;
select count(*)
FROM alpassint.tb_coc_emp_rprt_rel;
truncate table  alpassint.tb_coc_emp_rprt_rel;
COPY alpassint.tb_coc_emp_rprt_rel ("rprt_ref_no", "co_emp_ref_no", "del_yn") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_emp_rprt_rel_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
FROM alpassint.tb_coc_emp_rprt_rel;
COPY alpassint.tb_coc_emp_rprt_rel ("rprt_ref_no", "co_emp_ref_no", "del_yn") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_emp_rprt_rel_202509020835.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_coc_eqip ("eqip_ref_no", "eqip_invn_no", "eqip_nm", "eqip_tp", "eqip_desc", "eqip_stts", "orgn_cd",
                            ...
                            "last_chg_dttm") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_eqip_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
FROM alpassint.tb_coc_eqip_oprn_rel;
COPY alpassint.tb_coc_eqip_oprn_rel ("oprn_ref_no", "eqip_ref_no") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_eqip_oprn_rel_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_coc_oprn ("oprn_ref_no", "orgn_reff_no", "oprn_title", "oprn_stts", "oprn_tp", "oprn_addr",
                            ...
                            "oprn_cncl_rsn") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_oprn_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
FROM alpassint.tb_coc_oprn_tp_rel;
COPY alpassint.tb_coc_oprn_tp_rel ("oprn_ref_no", "oprn_tp_cd") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_oprn_tp_rel_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_coc_rprt ("rprt_ref_no", "rprt_tp_cd", "orgn_cd", "rprt_inf_ntr", "rprt_inf_dttm", "rprt_inf_plc",
                            ...
                            "unknown_yn", "chng_yn",
                            "chng_rsn") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_rprt_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_coc_rprt_cag ("rprt_cag_id", "rprt_cag_ctg_cd", "rprt_cag_nm", "rprt_cag_qty", "unit_cd",
                                ...
                                "del_yn") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_rprt_cag_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_coc_rprt_cmpny ("rprt_cmpny_id", "rprt_cmpny_tp_cd", "rprt_cmpny_nm", "rprt_cmpny_addr",
                                  ...
                                  "del_yn") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_rprt_cmpny_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_coc_rprt_h ("hist_id", "rprt_ref_no", "rprt_tp_cd", "orgn_cd", "rprt_inf_ntr", "rprt_inf_dttm",
                              ...
                              "update_by") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_rprt_h_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_coc_rprt_inc ("rprt_inc_ref_no", "orgn_cd", "rprt_inc_tp_cd", "rprt_inc_dttm", "rprt_inc_ttl",
                                ...
                                "last_chg_dttm") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_rprt_inc_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_coc_rprt_prsn ("rprt_prsn_id", "rprt_prsn_tp_cd", "rprt_prsn_nm", "rprt_prsn_fmnm",
                                 ...
                                 "del_yn") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_rprt_prsn_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_coc_rprt_trnp ("rprt_trnp_id", "rprt_trnp_mdl_cd", "rprt_trnp_brnd_cd", "rprt_trnp_rgsr_no",
                                 ...
                                 "rprt_trnp_tp_cd",
                                 "del_yn") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_rprt_trnp_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_coc_rprt_vyg ("rprt_vyg_id", "rprt_vyg_dptr", "rprt_vyg_dstn", "rprt_vyg_trnp_nm", "rprt_vyg_dt",
                                ...
                                "del_yn") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_rprt_vyg_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_coc_rprt_vyg_h ("hist_id", "rprt_vyg_id", "rprt_vyg_dptr", "rprt_vyg_dstn", "rprt_vyg_trnp_nm",
                                  ...
                                  "del_yn") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_rprt_vyg_h_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_coc_vhcl ("vhcl_ref_no", "vhcl_knd_cd", "vhcl_rgsr_no", "vhcl_chss_no", "vhcl_mnfc_yy", "vhcl_mdl_cd",
                            ...
                            "vhcl_cnd_cd") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_vhcl_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
FROM alpassint.tb_coc_vhcl_oprn_rel;
COPY alpassint.tb_coc_vhcl_oprn_rel ("oprn_ref_no", "vhcl_ref_no") FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_vhcl_oprn_rel_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_com_coc_vhcl_mdl ("vhcl_mdl_cd", "vhcl_mdl_nm", "vhcl_mnur_cd", "del_yn", "frst_regst_id",
                                    "frst_rgsr_dttm", "last_chpr_id",
                                    "last_chg_dttm") FROM 'C:\wrk\coc-data\cocDb\csv\tb_com_coc_vhcl_mdl_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_com_coc_vhcl_mnur ("vhcl_mnur_cd", "vhcl_mnur_nm", "del_yn", "frst_regst_id", "frst_rgsr_dttm",
                                     "last_chpr_id",
                                     "last_chg_dttm") FROM 'C:\wrk\coc-data\cocDb\csv\tb_com_coc_vhcl_mnur_202509020829.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_com_comm_cd ("comm_id", "wly_cd", "del_yn", "frst_regst_id", "frst_rgsr_dttm", "last_chpr_id",
                               "last_chg_dttm") FROM 'C:\wrk\coc-data\cocDb\csv\tb_com_comm_cd_202509020833.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_com_comm_cd_lang ("comm_id", "lang_cd", "comm_nm", "daira_nm", "del_yn", "frst_regst_id",
                                    "frst_rgsr_dttm", "last_chpr_id",
                                    "last_chg_dttm") FROM 'C:\wrk\coc-data\cocDb\csv\tb_com_comm_cd_lang_202509020833.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_com_comn_cd ("comn_cd", "bsop_clsf_cd", "upr_comn_cd", "cd_desc", "xtrn_ofr_yn", "use_yn", "del_yn",
                               "frst_regst_id", "frst_rgsr_dttm", "last_chpr_id", "last_chg_dttm",
                               "atch_file_id") FROM 'C:\wrk\coc-data\cocDb\csv\tb_com_comn_cd_202509020833.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_com_comn_cd_d ("comn_cd", "cd_vdval", "upr_comn_cd", "upr_cd_vdval", "vald_strt_dt", "vald_end_dt",
                                 ...
                                 "user_defn_vdval3") FROM 'C:\wrk\coc-data\cocDb\csv\tb_com_comn_cd_d_202509020833.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_com_comn_cd_d_lang ("comn_cd", "cd_vdval", "lang_cd", "cd_vdval_nm", "del_yn", "frst_regst_id",
                                      "frst_rgsr_dttm", "last_chpr_id",
                                      "last_chg_dttm") FROM 'C:\wrk\coc-data\cocDb\csv\tb_com_comn_cd_d_lang_202509020833.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_com_prcs_stts_infm ("msg_id", "rcpn_msg_id", "bsop_clsf_cd", "prcs_stts_cd", "dclr_doc_cd",
                                      ...
                                      "last_chg_dttm") FROM 'C:\wrk\coc-data\cocDb\csv\tb_com_prcs_stts_infm_202509020835.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_com_psn_user_auth ("role_id", "user_id", "use_yn", "del_yn", "frst_regst_id", "frst_rgsr_dttm",
                                     "last_chpr_id",
                                     "last_chg_dttm") FROM 'C:\wrk\coc-data\cocDb\csv\tb_com_psn_user_auth_202509020835.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_com_temp_atch_file ("temp_atch_file_id", "srbk_file_nm", "save_file_nm", "file_path_nm", "file_size",
                                      ...
                                      "last_chg_dttm",
                                      "file_desc_cn") FROM 'C:\wrk\coc-data\cocDb\csv\tb_com_temp_atch_file_202509020835.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_com_user_acct ("user_id", "pwd", "pwd_chg_dt", "pwd_intz_yn", "pwd_fail_ncnt", "acct_lcked_yn",
                                 ...
                                 "user_clsf_cd") FROM 'C:\wrk\coc-data\cocDb\csv\tb_com_user_acct_202509020835.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_com_wrhs_jrsd_emp ("pbsr_no", "nif", "co_dclr_cd", "del_yn", "frst_regst_id", "frst_rgsr_dttm",
                                     "last_chpr_id",
                                     "last_chg_dttm") FROM 'C:\wrk\coc-data\cocDb\csv\tb_com_wrhs_jrsd_emp_202509020835.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_pote_cntt_actv_mtr_cd_temp ("msg_id", "msg_prcs_stts_cd", "actv_mtr_cd", "actv_mtr_cd_nm", "del_yn",
                                              "frst_regst_id", "frst_rgsr_dttm", "last_chpr_id", "last_chg_dttm",
                                              "btch_prcc_yn", "code",
                                              "libelle") FROM 'C:\wrk\coc-data\cocDb\csv\tb_pote_cntt_actv_mtr_cd_temp_202509020835.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_pote_cntt_cmrc_regs_actv_mtr_temp ("msg_id", "msg_prcs_stts_cd", "cmrc_regs_no", "actv_mtr_cd",
                                                     ...
                                                     "code") FROM 'C:\wrk\coc-data\cocDb\csv\tb_pote_cntt_cmrc_regs_actv_mtr_temp_202509020835.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_pote_cntt_cmrc_regs_temp ("msg_id", "msg_prcs_stts_cd", "cmrc_regs_no", "ents_cd", "wly_cd", "nif_cd",
                                            ...
                                            "commue") FROM 'C:\wrk\coc-data\cocDb\csv\tb_pote_cntt_cmrc_regs_temp_202509020835.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_pote_cntt_nif_temp ("msg_id", "msg_prcs_stts_cd", "potx_cd", "potx_srno", "conm", "co_addr", "wly_nm",
                                      ...
                                      "date_suivi") FROM 'C:\wrk\coc-data\cocDb\csv\tb_pote_cntt_nif_temp_202509020835.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_pote_cntt_prsn_regs_temp ("msg_id", "msg_prcs_stts_cd", "cmrc_regs_no", "ents_cd", "wly_cd", "nif_cd",
                                            ...
                                            "date_radiat") FROM 'C:\wrk\coc-data\cocDb\csv\tb_pote_cntt_prsn_regs_temp_202509020835.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_poti_co_emp ("pbsr_no", "emp_nm", "emp_stts_cd", "inhb_rgsr_no", "eml", "brdy", "gndr_cd", "mobl_no",
                               ...
                               "orgn_cd") FROM 'C:\wrk\coc-data\cocDb\csv\tb_poti_co_emp_202509020835.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_poti_emp ("pbsr_no", "orgn_mgmt_cd", "emp_nm", "cstm_emp_no", "emp_stts_cd", "ctgy_cd", "gd_cd",
                            ...
                            "apot_atch_file_id",
                            "temp_brdy") FROM 'C:\wrk\coc-data\cocDb\csv\tb_poti_emp_202509020835.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_poti_emp_acct ("pbsr_no", "pwd", "pwd_chg_dt", "pwd_intz_yn", "pwd_fail_ncnt", "acct_lcked_yn",
                                 ...
                                 "frst_regst_id", "frst_rgsr_dttm", "last_chpr_id", "last_chg_dttm", "frst_lgn_yn",
                                 "last_lgn_dttm",
                                 "adit_crtf_cd") FROM 'C:\wrk\coc-data\cocDb\csv\tb_poti_emp_acct_202509020835.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_poti_emp_auth ("pbsr_no", "role_id", "mn_role_yn", "auth_vald_strt_dt", "auth_vald_end_dt",
                                 ...
                                 "frst_regst_id", "frst_rgsr_dttm", "last_chpr_id", "last_chg_dttm",
                                 "orgn_cd") FROM 'C:\wrk\coc-data\cocDb\csv\tb_poti_emp_auth_202509020835.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_poti_emp_auth_h ("pbsr_no", "role_id", "srno", "auth_athz_cd", "wrkr", "wkng_dttm", "del_yn",
                                   ...
                                   "last_chg_dttm") FROM 'C:\wrk\coc-data\cocDb\csv\tb_poti_emp_auth_h_202509020835.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_poti_emp_bak ("pbsr_no", "orgn_mgmt_cd", "emp_nm", "cstm_emp_no", "emp_stts_cd", "ctgy_cd", "gd_cd",
                                ...
                                "fonc_cd") FROM 'C:\wrk\coc-data\cocDb\csv\tb_poti_emp_bak_202509020835.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_poti_emp_bwrk_stts_hist ("pbsr_no", "hist_srno", "emp_stts_cd", "emp_stts_chg_rsn_cn", "aply_strt_dt",
                                           ...
                                           "xtns_rsn_cn",
                                           "xtns_yn") FROM 'C:\wrk\coc-data\cocDb\csv\tb_poti_emp_bwrk_stts_hist_202509020835.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_poti_emp_fonc_hist ("pbsr_no", "srno", "fonc_cd", "bf_fonc_cd", "bf_grd_cd", "fonc_stts_cd",
                                      ...
                                      "prcs_stts_cd") FROM 'C:\wrk\coc-data\cocDb\csv\tb_poti_emp_fonc_hist_202509020835.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_poti_emp_h ("pbsr_no", "col_nm", "chg_hist_srno", "bfch_cn", "afch_cn", "del_yn", "frst_regst_id",
                              ...
                              "chg_tp_cd") FROM 'C:\wrk\coc-data\cocDb\csv\tb_poti_emp_h_202509020835.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_poti_impv_opin ("impv_opin_srno", "app_clsf_cd", "impv_opin_tp_cd", "impv_opin_ttle", "impv_opin_cn",
                                  ...
                                  "pbsr_no") FROM 'C:\wrk\coc-data\cocDb\csv\tb_poti_impv_opin_202509020835.csv' DELIMITER ',' CSV HEADER;
select count(*)
...
COPY alpassint.tb_poti_orgn ("orgn_mgmt_cd", "orgn_cd", "orgn_tp_cd", "orgn_nm", "orgn_desc", "orgn_regn_cd",
                             ...
                             "rit_ac_no") FROM 'C:\wrk\coc-data\cocDb\csv\tb_poti_orgn_202509020845.csv' DELIMITER ',' CSV HEADER;
