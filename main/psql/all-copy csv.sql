...
COPY alpassint.tb_coc_amo_oprn_rel ("oprn_ref_no", "amo_qty", "amo_ref_no")
    FROM 'C:\wrk\coc-data\cocDb\csv\tb_coc_amo_oprn_rel_202509020829.csv' DELIMITER ',' CSV HEADER;
/*select count(*)
